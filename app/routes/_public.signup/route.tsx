  ...
  return (
    <div>
      ...
      <Form method='post'>
        ...
        <input type='password' name='password' className='border-b mb-10 block w-full p-1' placeholder='Enter password' />
        <div className='flex justify-between'>
          <button className='text-white bg-blue-500 hover:bg-blue-600 py-1 px-4 rounded-lg'>Signup</button>
